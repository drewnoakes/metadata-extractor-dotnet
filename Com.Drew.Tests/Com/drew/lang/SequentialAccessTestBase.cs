...
namespace Com.Drew.Lang
{
    ...
    public abstract class SequentialAccessTestBase
    {
        ...
        public virtual void TestGetInt8()
        {
            ...
            Tests.AreEqual(unchecked((sbyte)0), reader.GetInt8());
            Tests.AreEqual(unchecked((sbyte)1), reader.GetInt8());
            Tests.AreEqual(unchecked((sbyte)127), reader.GetInt8());
            Tests.AreEqual(unchecked((sbyte)255), reader.GetInt8());
        }
        ...
        public virtual void TestGetUInt8()
        {
            sbyte[] buffer = new sbyte[] { unchecked((int)(0x00)), unchecked((int)(0x01)), unchecked((sbyte)0x7F), unchecked((sbyte)0xFF) };
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual(0, reader.GetUInt8());
            Tests.AreEqual(1, reader.GetUInt8());
            Tests.AreEqual(127, reader.GetUInt8());
            Tests.AreEqual(255, reader.GetUInt8());
        }
        ...
        public virtual void TestGetUInt8_OutOfBounds()
        {
            ...
            {
                Tests.AreEqual("End of data reached.", ex.Message);
            }
        }
        ...
        {
            Tests.AreEqual(-1, CreateReader(new sbyte[] { unchecked((sbyte)0xff), unchecked((sbyte)0xff) }).GetInt16());
            sbyte[] buffer = new sbyte[] { unchecked((int)(0x00)), unchecked((int)(0x01)), unchecked((sbyte)0x7F), unchecked((sbyte)0xFF) };
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual((short)0x0001, reader.GetInt16());
            Tests.AreEqual((short)0x7FFF, reader.GetInt16());
            reader = CreateReader(buffer);
            reader.SetMotorolaByteOrder(false);
            Tests.AreEqual((short)0x0100, reader.GetInt16());
            Tests.AreEqual(unchecked((short)(0xFF7F)), reader.GetInt16());
        }
        ...
        public virtual void TestGetUInt16()
        {
            sbyte[] buffer = new sbyte[] { unchecked((int)(0x00)), unchecked((int)(0x01)), unchecked((sbyte)0x7F), unchecked((sbyte)0xFF) };
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual(unchecked((int)(0x0001)), reader.GetUInt16());
            Tests.AreEqual(unchecked((int)(0x7FFF)), reader.GetUInt16());
            reader = CreateReader(buffer);
            reader.SetMotorolaByteOrder(false);
            Tests.AreEqual(unchecked((int)(0x0100)), reader.GetUInt16());
            Tests.AreEqual(unchecked((int)(0xFF7F)), reader.GetUInt16());
        }
        ...
        {
            Tests.AreEqual(-1, CreateReader(new sbyte[] { unchecked((sbyte)0xff), unchecked((sbyte)0xff), unchecked((sbyte)0xff), unchecked((sbyte)0xff) }).GetInt32());
            ...
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual(unchecked((int)(0x00010203)), reader.GetInt32());
            Tests.AreEqual(unchecked((int)(0x04050607)), reader.GetInt32());
            reader = CreateReader(buffer);
            reader.SetMotorolaByteOrder(false);
            Tests.AreEqual(unchecked((int)(0x03020100)), reader.GetInt32());
            Tests.AreEqual(unchecked((int)(0x07060504)), reader.GetInt32());
        }
        ...
        {
            Tests.AreEqual(4294967295L, CreateReader(new sbyte[] { unchecked((sbyte)0xff), unchecked((sbyte)0xff), unchecked((sbyte)0xff), unchecked((sbyte)0xff) }).GetUInt32());
            ...
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual(unchecked((long)(0xFF000102L)), reader.GetUInt32());
            Tests.AreEqual(unchecked((long)(0x03040506L)), reader.GetUInt32());
            reader = CreateReader(buffer);
            reader.SetMotorolaByteOrder(false);
            Tests.AreEqual(unchecked((long)(0x020100FFL)), reader.GetUInt32());
            // 0x0010200FF
            Tests.AreEqual(unchecked((long)(0x06050403L)), reader.GetUInt32());
        }
        ...
        public virtual void TestGetInt64()
        {
            ...
            SequentialReader reader = CreateReader(buffer);
            Tests.AreEqual(unchecked((long)(0xFF00010203040506L)), reader.GetInt64());
            reader = CreateReader(buffer);
            reader.SetMotorolaByteOrder(false);
            Tests.AreEqual(unchecked((long)(0x06050403020100FFL)), reader.GetInt64());
        }
        ...
        public virtual void TestGetFloat32()
        {
            ...
            SequentialReader reader = CreateReader(buffer);
            Tests.IsTrue(float.IsNaN(reader.GetFloat32()));
        }
        ...
        public virtual void TestGetFloat64()
        {
            ...
            SequentialReader reader = CreateReader(buffer);
            Tests.IsTrue(double.IsNaN(reader.GetDouble64()));
        }
        ...
        public virtual void TestGetNullTerminatedString()
        {
            ...
            {
                Tests.AreEqual(Runtime.Substring("ABCDEFG", 0, i), CreateReader(bytes).GetNullTerminatedString(i));
            }
            Tests.AreEqual(string.Empty, CreateReader(new sbyte[] { 0 }).GetNullTerminatedString(10));
            Tests.AreEqual("A", CreateReader(new sbyte[] { unchecked((int)(0x41)), 0 }).GetNullTerminatedString(10));
            Tests.AreEqual("AB", CreateReader(new sbyte[] { unchecked((int)(0x41)), unchecked((int)(0x42)), 0 }).GetNullTerminatedString(10));
            Tests.AreEqual("AB", CreateReader(new sbyte[] { unchecked((int)(0x41)), unchecked((int)(0x42)), 0, unchecked((int)(0x43)) }).GetNullTerminatedString(10));
        }
        ...
        public virtual void TestGetString()
        {
            ...
            Tests.AreEqual(bytes.Length, expected.Length);
            for (int i = 0; i < bytes.Length; i++)
            {
                Tests.AreEqual(Runtime.Substring("ABCDEFG", 0, i), CreateReader(bytes).GetString(i));
            }
        }
        ...
        public virtual void TestGetBytes()
        {
            ...
            for (int i = 0; i < bytes.Length; i++)
            {
                ...
                for (int j = 0; j < i; j++)
                {
                    Tests.AreEqual(bytes[j], readBytes[j]);
                }
            }
        }
        ...
        public virtual void TestOverflowBoundsCalculation()
        {
            ...
            {
                Tests.AreEqual("End of data reached.", e.Message);
            }
        }
        ...
        {
            Tests.IsTrue(CreateReader(new sbyte[1]).TrySkip(1));
            SequentialReader reader = CreateReader(new sbyte[2]);
            Tests.IsTrue(reader.TrySkip(1));
            Tests.IsTrue(reader.TrySkip(1));
            Tests.IsFalse(reader.TrySkip(1));
        }
    }
}
