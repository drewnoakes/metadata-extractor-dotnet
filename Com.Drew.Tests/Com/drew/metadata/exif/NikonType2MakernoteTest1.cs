...
namespace Com.Drew.Metadata.Exif
{
    ...
    */
        ...
        public void TestGetAutoFlashCompensationDescription()
        {
            ...
            directory.SetSByteArray(NikonType2MakernoteDirectory.TagAutoFlashCompensation, new sbyte[] { unchecked(0x04), unchecked(0x01), unchecked(0x06) });
            Assert.AreEqual("0.67 EV", descriptor.GetAutoFlashCompensationDescription());
            directory.SetSByteArray(NikonType2MakernoteDirectory.TagAutoFlashCompensation, new sbyte[] { unchecked(0x02), unchecked(0x01), unchecked(0x06) });
            Assert.AreEqual("0.33 EV", descriptor.GetAutoFlashCompensationDescription());
            directory.SetSByteArray(NikonType2MakernoteDirectory.TagAutoFlashCompensation, new sbyte[] { unchecked((sbyte)0xFE), unchecked(0x01), unchecked(0x06) });
            Assert.AreEqual("-0.33 EV", descriptor.GetAutoFlashCompensationDescription());
        }
    }
}
