...
public sealed class OlympusEquipmentMakernoteDescriptor(OlympusEquipmentMakernoteDirectory directory)
    : TagDescriptor<OlympusEquipmentMakernoteDirectory>(directory)
{
