...
namespace MetadataExtractor.Formats.Exif.Makernotes
{
    ...
    public sealed class FujifilmMakernoteDescriptor : TagDescriptor<FujifilmMakernoteDirectory>
    {
        ...
        {
            int value;
            if (!Directory.TryGetInt32(FujifilmMakernoteDirectory.TagNoiseReduction, out value))
                return null;
            switch (value)
            {
                case 0x040:
        ...
        {
            int value;
            if (!Directory.TryGetInt32(FujifilmMakernoteDirectory.TagFinePixColor, out value))
                return null;
            switch (value)
            {
                case 0x00:
