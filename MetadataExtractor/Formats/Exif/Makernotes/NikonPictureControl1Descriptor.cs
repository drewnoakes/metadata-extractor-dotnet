...
public sealed class NikonPictureControl1Descriptor(NikonPictureControl1Directory directory)
    : TagDescriptor<NikonPictureControl1Directory>(directory)
{
    ...
    {
        return GetIndexedDescription(TagPictureControlAdjust, [
            "Default Settings",
            "Quick Adjust",
            "Full Control"
        ]);
