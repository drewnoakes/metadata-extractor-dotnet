...
public sealed class HuffmanTablesDirectory : Directory
{
    ...
    public static ReadOnlySpan<byte> TypicalLuminanceDcLengths => [
        0x00, 0x01, 0x05, 0x01, 0x01, 0x01, 0x01, 0x01,
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    ];

    public static ReadOnlySpan<byte> TypicalLuminanceDcValues => [
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
        0x08, 0x09, 0x0A, 0x0B
    ];

    public static ReadOnlySpan<byte> TypicalChrominanceDcLengths => [
        0x00, 0x03, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
        0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ];

    public static ReadOnlySpan<byte> TypicalChrominanceDcValues => [
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
        0x08, 0x09, 0x0A, 0x0B
    ];

    public static ReadOnlySpan<byte> TypicalLuminanceAcLengths => [
        0x00, 0x02, 0x01, 0x03, 0x03, 0x02, 0x04, 0x03,
        0x05, 0x05, 0x04, 0x04, 0x00, 0x00, 0x01, 0x7D
    ];

    public static ReadOnlySpan<byte> TypicalLuminanceAcValues => [
    ...
    public static ReadOnlySpan<byte> TypicalChrominanceAcLengths => [
        0x00, 0x02, 0x01, 0x02, 0x04, 0x04, 0x03, 0x04,
        0x07, 0x05, 0x04, 0x04, 0x00, 0x01, 0x02, 0x77
    ];

    public static ReadOnlySpan<byte> TypicalChrominanceAcValues => [
