...
namespace Com.Adobe.Xmp
{
	...
	/// <p>
	/// An <code>XMPIterator</code> is created by XMPMeta#Iterator() constructor
	...
	/// <ul>
	/// <li>JustChildren - Visit just the immediate children of the root. Skip
	...
	/// <li>JustLeafnodes - Visit just the leaf property nodes and their
	/// qualifiers.
	/// <li>JustLeafname - Return just the leaf component of the node names.
	/// The default is to return the full xmp path.
	/// <li>OmitQualifiers - Do not visit the qualifiers.
