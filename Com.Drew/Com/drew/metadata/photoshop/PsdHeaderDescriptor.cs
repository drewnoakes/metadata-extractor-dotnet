    ...
    public class PsdHeaderDescriptor : TagDescriptor<PsdHeaderDirectory>
    {
        ...
        public virtual string GetChannelCountDescription()
        {
            try
            {
                ...
                int? value = Directory.GetInteger(PsdHeaderDirectory.TagChannelCount);
                if (value == null)
                {
                    return null;
                }
        ...
        public virtual string GetBitsPerChannelDescription()
        {
            try
            {
                ...
                int? value = Directory.GetInteger(PsdHeaderDirectory.TagBitsPerChannel);
                if (value == null)
                {
                    return null;
                }
        ...
        public virtual string GetColorModeDescription()
        {
            ...
            try
            {
                int? value = Directory.GetInteger(PsdHeaderDirectory.TagColorMode);
                if (value == null)
                {
                    return null;
                }
        ...
        public virtual string GetImageHeightDescription()
        {
            try
            {
                int? value = Directory.GetInteger(PsdHeaderDirectory.TagImageHeight);
                if (value == null)
                {
                    return null;
                }
        ...
        public virtual string GetImageWidthDescription()
        {
            try
            {
                int? value = Directory.GetInteger(PsdHeaderDirectory.TagImageWidth);
                if (value == null)
                {
                    return null;
                }
